...
var _user$project$Models$Model = F2(
	function (a, b) {
		return {appState: a, appContent: b};
	});
var _user$project$Models$AppState = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {selectedNavIcon: a, currentRoute: b, currentSortOption: c, currentSortOrder: d, currentPage: e, currentFilterByCountry: f, formSubmitted: g, formPhone: h, formFailureMessage: i, selectedBlogEntryId: j};
									};
								};
							};
						};
...
var _user$project$Models$AppContent = F3(
	function (a, b, c) {
		return {countries: a, hotels: b, blog: c};
	});
var _user$project$Models$Country = F3(
	function (a, b, c) {
		return {id: a, name: b, nameLocativeCase: c};
	});
var _user$project$Models$Hotel = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {id: a, name: b, popularity: c, countryId: d, stars: e, bgPhotoUrl: f, photoUrls: g, priceOptions: h, duration: i, depart: j, photoUrls: k, videoUrl: l, description: m, features: n, postDescription: o};
														};
													};
												};
											};
...
var _user$project$Models$BlogEntry = F4(
	function (a, b, c, d) {
		return {id: a, timePosted: b, header: c, fullText: d};
	});
var _user$project$Models$PriceOption = F3(
	function (a, b, c) {
		return {name: a, personCapacity: b, price: c};
	});
var _user$project$Models$ToggleBlogEntrySelected = function (a) {
	return {ctor: 'ToggleBlogEntrySelected', _0: a};
};
var _user$project$Models$FormSubmit = {ctor: 'FormSubmit'};
var _user$project$Models$FormPhoneChange = function (a) {
	return {ctor: 'FormPhoneChange', _0: a};
};
var _user$project$Models$Pagination = function (a) {
	return {ctor: 'Pagination', _0: a};
};
var _user$project$Models$SetFilterByCountry = function (a) {
	return {ctor: 'SetFilterByCountry', _0: a};
};
var _user$project$Models$LogoClick = {ctor: 'LogoClick'};
var _user$project$Models$RouteChange = function (a) {
	return {ctor: 'RouteChange', _0: a};
};
var _user$project$Models$SortOptionSelect = F2(
	function (a, b) {
		return {ctor: 'SortOptionSelect', _0: a, _1: b};
	});
var _user$project$Models$NavIconClick = function (a) {
	return {ctor: 'NavIconClick', _0: a};
};
var _user$project$Models$HotelPage = function (a) {
	return {ctor: 'HotelPage', _0: a};
};
var _user$project$Models$MenuPage = {ctor: 'MenuPage'};
var _user$project$Models$Depart = {ctor: 'Depart'};
var _user$project$Models$Price = {ctor: 'Price'};
var _user$project$Models$Stars = {ctor: 'Stars'};
var _user$project$Models$Popularity = {ctor: 'Popularity'};
var _user$project$Models$Desc = {ctor: 'Desc'};
var _user$project$Models$Asc = {ctor: 'Asc'};
...
var _user$project$ContentLayout$renderFooter = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Зв\'яжіться з нами:')
				])),
			A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('numbers-container')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('+38 (044) 123 45 67')
						])),
					A2(
					_elm_lang$html$Html$span,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('+38 (044) 123 45 68')
						])),
					A2(
					_elm_lang$html$Html$span,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('+38 (044) 123 45 69')
						])),
					A2(
					_elm_lang$html$Html$span,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('+38 (044) 123 45 70')
						]))
				])),
			A2(
			_elm_lang$html$Html$div,
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Returnal Inc. © All rights reserved')
				]))
		]));
var _user$project$ContentLayout$renderHeader = function (model) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onClick(_user$project$Models$LogoClick)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				_user$project$RightBlock$renderTopMostNavIcons(model.appState)
			]));
};
var _user$project$ContentLayout$renderMetadata = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$rel('stylesheet/less'),
					_elm_lang$html$Html_Attributes$href('less/style.less')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A3(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html_Attributes$href('https://fonts.googleapis.com/css?family=Amatica+SC:400,700|Cairo:200,300,400,600,700,900|Oranienbaum|Rubik:300,300i,400,400i,500,500i,700,700i,900,900i&amp;subset=cyrillic')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A3(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$src('https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.min.js')
				]),
			_elm_lang$core$Native_List.fromArray(
				[]))
		]));
var _user$project$ContentLayout$renderLayout = F2(
	function (renderContent, model) {
		return A2(
			...
			A2(
				_elm_lang$core$List_ops['::'],
				_user$project$ContentLayout$renderMetadata,
				A2(
					_elm_lang$core$List_ops['::'],
					_user$project$ContentLayout$renderHeader(model),
					A2(
						_elm_lang$core$List_ops['::'],
						_user$project$MainContent$renderMainContent(model),
						A2(
							_elm_lang$core$List_ops['::'],
							_user$project$ContentLayout$renderFooter,
							_elm_lang$core$Native_List.fromArray(
								[]))))));
	});
